<?php
session_start();
$_SESSION['quiz'] = "digitalsignalprocessing";
...
<body>
    ...
    <div class="container-fluid justify-content-center">
        <?php 
        $sql = "SELECT * FROM digitalsignalprocessing";
        $result = mysqli_query($con,$sql);
        echo "<form action='verify-dsp.php' class='ml-auto mr-auto' method='POST'>";
        ...
        echo "<button id='submit' type='submit' name='submit' class='btn btn-dark btn-block'>Finish Attempt</button>";
        echo "</form>"
        ?>
    </div>
